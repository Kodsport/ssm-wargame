...
func (r *challengeR) GetChallengeGroupChallenges() ChallengeGroupChallengeSlice {
	if r == nil {
		return nil
	}
...
func (o *Challenge) ChallengeGroupChallenges(mods ...qm.QueryMod) challengeGroupChallengeQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
...
func (challengeL) LoadMonthlyChallenge(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`monthly_challenges.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadChallengeFiles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`challenge_files.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (challengeL) LoadChallengeGroupChallenges(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	var slice []*Challenge
	var object *Challenge
	...
	query := NewQuery(
		...
		qm.WhereIn(`challenge_group_challenges.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadChallengeServices(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`challenge_services.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadCTFChallenges(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`ctf_challenges.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadCTFSolves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`ctf_solves`),
		qm.WhereIn(`ctf_solves.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadFlags(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`flags`),
		qm.WhereIn(`flags.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadKnackKodenSolves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		...
		qm.WhereIn(`knack_koden_solves.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadSubmissions(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`submissions`),
		qm.WhereIn(`submissions.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (challengeL) LoadUserSolves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChallenge interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_solves`),
		qm.WhereIn(`user_solves.challenge_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// Sets related.R.Challenge appropriately.
func (o *Challenge) AddChallengeGroupChallenges(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ChallengeGroupChallenge) error {
	var err error
	for _, rel := range related {
		if insert {
...
func (o *Challenge) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
	...
	if !cached {
		...
		cache.query = buildUpsertQueryPostgres(dialect, "\"challenges\"", updateOnConflict, ret, update, conflict, insert)
