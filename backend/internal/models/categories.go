...
func (r *categoryR) GetChallenges() ChallengeSlice {
	if r == nil {
		return nil
	}
	return r.Challenges
...
var (
	...
	categoryColumnsWithDefault    = []string{"created_at", "updated_at"}
...
func (o *Category) Challenges(mods ...qm.QueryMod) challengeQuery {
...
func (categoryL) LoadChallenges(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCategory interface{}, mods queries.Applicator) error {
	var slice []*Category
	var object *Category
	...
	query := NewQuery(
		qm.Select("\"challenges\".\"id\", \"challenges\".\"slug\", \"challenges\".\"title\", \"challenges\".\"description\", \"challenges\".\"score\", \"challenges\".\"published\", \"challenges\".\"ctf_event_id\", \"challenges\".\"created_at\", \"challenges\".\"updated_at\", \"a\".\"category_id\""),
		qm.From("\"challenges\""),
