...
type School struct {
	...
	GeographicalAreaCode null.Int  `boil:"geographical_area_code" json:"geographical_area_code,omitempty" toml:"geographical_area_code" yaml:"geographical_area_code,omitempty"`
...
var SchoolWhere = struct {
	...
	GeographicalAreaCode whereHelpernull_Int
	CreatedAt            whereHelpertime_Time
	UpdatedAt            whereHelpernull_Time
}{
	ID:                   whereHelperint{field: "\"schools\".\"id\""},
	Name:                 whereHelperstring{field: "\"schools\".\"name\""},
	GeographicalAreaCode: whereHelpernull_Int{field: "\"schools\".\"geographical_area_code\""},
...
var (
	schoolAllColumns            = []string{"id", "name", "geographical_area_code", "created_at", "updated_at"}
	schoolColumnsWithoutDefault = []string{"id", "name"}
	schoolColumnsWithDefault    = []string{"geographical_area_code", "created_at", "updated_at"}
