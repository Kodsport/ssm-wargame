...
func (r *schoolR) GetSchoolSolves() SchoolSolfSlice {
	if r == nil {
		return nil
	}
...
var schoolAfterSelectMu sync.Mutex
var schoolAfterSelectHooks []SchoolHook

var schoolBeforeInsertMu sync.Mutex
var schoolBeforeInsertHooks []SchoolHook
var schoolAfterInsertMu sync.Mutex
var schoolAfterInsertHooks []SchoolHook

var schoolBeforeUpdateMu sync.Mutex
var schoolBeforeUpdateHooks []SchoolHook
var schoolAfterUpdateMu sync.Mutex
var schoolAfterUpdateHooks []SchoolHook

var schoolBeforeDeleteMu sync.Mutex
var schoolBeforeDeleteHooks []SchoolHook
var schoolAfterDeleteMu sync.Mutex
var schoolAfterDeleteHooks []SchoolHook

var schoolBeforeUpsertMu sync.Mutex
var schoolBeforeUpsertHooks []SchoolHook
var schoolAfterUpsertMu sync.Mutex
...
func (o *School) SchoolSolves(mods ...qm.QueryMod) schoolSolfQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"school_solves\".\"school_id\"=?", o.ID),
	)
...
func (schoolL) LoadSchoolSolves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSchool interface{}, mods queries.Applicator) error {
	var slice []*School
	var object *School
	...
	query := NewQuery(
		...
		qm.WhereIn(`school_solves.school_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (schoolL) LoadUsers(ctx context.Context, e boil.ContextExecutor, singular bool, maybeSchool interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`users`),
		qm.WhereIn(`users.school_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *School) AddSchoolSolves(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*SchoolSolf) error {
	var err error
...
func (o *School) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
	...
	if !cached {
		...
		ret := strmangle.SetComplement(schoolAllColumns, strmangle.SetIntersect(insert, update))

		conflict := conflictColumns
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(schoolPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert schools, could not build conflict column list")
			}

			conflict = make([]string, len(schoolPrimaryKeyColumns))
			copy(conflict, schoolPrimaryKeyColumns)
		}
		cache.query = buildUpsertQueryPostgres(dialect, "\"schools\"", updateOnConflict, ret, update, conflict, insert, opts...)
