...
func (r *userR) GetCourseEnrollments() CourseEnrollmentSlice {
	if r == nil {
		return nil
	}
...
func (r *userR) GetSchoolSolves() SchoolSolfSlice {
	if r == nil {
		return nil
	}
...
func (o *User) CourseEnrollments(mods ...qm.QueryMod) courseEnrollmentQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"course_enrollments\".\"user_id\"=?", o.ID),
	)
...
func (o *User) SchoolSolves(mods ...qm.QueryMod) schoolSolfQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"school_solves\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadCourseEnrollments(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`course_enrollments.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadSchoolSolves(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`school_solves.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddCourseEnrollments(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*CourseEnrollment) error {
	var err error
...
// Sets related.R.User appropriately.
func (o *User) AddSchoolSolves(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*SchoolSolf) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
