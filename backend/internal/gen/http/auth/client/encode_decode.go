...
// endpoint
func (c *Client) BuildGenerateDiscordAuthURLRequest(ctx context.Context, v any) (*http.Request, error) {
...
func DecodeGenerateDiscordAuthURLResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
...
func (c *Client) BuildExchangeDiscordRequest(ctx context.Context, v any) (*http.Request, error) {
...
func EncodeExchangeDiscordRequest(encoder func(*http.Request) goahttp.Encoder) func(*http.Request, any) error {
...
func DecodeExchangeDiscordResponse(decoder func(*http.Response) goahttp.Decoder, restoreBody bool) func(*http.Response) (any, error) {
	return func(resp *http.Response) (any, error) {
		if restoreBody {
			b, err := io.ReadAll(resp.Body)
			if err != nil {
