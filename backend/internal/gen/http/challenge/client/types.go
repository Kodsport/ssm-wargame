...
// NewGetCurrentMonthlyChallengeNotFound builds a challenge service
// GetCurrentMonthlyChallenge endpoint not_found error.
func NewGetCurrentMonthlyChallengeNotFound(body *GetCurrentMonthlyChallengeNotFoundResponseBody) *goa.ServiceError {
	v := &goa.ServiceError{
		Name:      *body.Name,
		ID:        *body.ID,
