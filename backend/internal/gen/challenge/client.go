...
// ListEvents calls the "ListEvents" endpoint of the "challenge" service.
func (c *Client) ListEvents(ctx context.Context, p *ListEventsPayload) (res []*CTFEvent, err error) {
	var ires interface{}
