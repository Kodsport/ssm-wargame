    ...
    <div class="row">
      <div class="col-12 col-md-6">
        ...
        <p>
          ...
          <a class="btn btn-primary" href="https://ctf.sakerhetssm.se/"
            >Till tävlingsplatformen</a
          >
        </p>
        <p>
          Joina gärna
          ...
          också en
          <a href="https://mail.sakerhetssm.se/subscription/form"
            >mailinglista</a
          >
        ...
        <form
          method="post"
          action="https://mail.sakerhetssm.se/subscription/form"
          class="listmonk-form"
        >
      ...
      <div
        v-else-if="scoreboard.nonUniScores"
        class="col pt-4 pt-md-0 text-primary"
      >
        <h1>Poängtavla</h1>
        <table class="table">
          <thead>
